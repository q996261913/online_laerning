						...
						<form class="am-form am-form-horizontal" id="information-form"
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-10">
									<!--用户名,不可更改-->
									<input type="text" id="username" name="username" value="${loginUser.username}" disabled>
								</div>
							</div>
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-10">
									...
									<label class="radio-inline">
										<input name="sex" class="gender" type="radio" id="femaleRadio" value="Female"<%if ("Female".equals(sex)) {%> checked <%}%> >女
									</label>
									<label class="radio-inline">
										<input name="sex" class="gender" type="radio" id="maleRadio" value="Male"
