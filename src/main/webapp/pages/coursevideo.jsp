...
<div class="container-fluid" style="text-align: center;">
    <video controls="controls">
        <source src="style/video/${course.id }.ogg"
    ...
    <div
        ...
        <form action="subreview" method="post">
            ...
            <div
                ...
                <input type="radio" name="lable" value="2">还行<br>
				<input type="radio" name="lable" value="3">不错<br>
				<input type="radio" name="lable" value="4">非常好<br>
            </div>
            <div
